...
public class ZooKeeper implements AutoCloseable {
     ...
     *
     * We are implementing this as a nested嵌套的，内装的 class of ZooKeeper so that
    ...
    public ZooKeeper(
        ...
        // 就是zookeeper 构造方法中的那个watcher
        watchManager.defaultWatcher = watcher;
        // 用来解析程序员传入的地址，因为集群状态会传入多个地址
        ConnectStringParser connectStringParser = new ConnectStringParser(connectString);
        // 集群状态下传入了多个地址，那么客户端应该连接哪一个？ 这个类就是负责找出一个地址连接
        hostProvider = aHostProvider;

        //ClientCnxn  客户端的连接对象，这个对象是实现客户端连接服务端的核心
    ...
    public ZooKeeper(
        ...
        boolean canBeReadOnly) throws IOException {
        /**
         * 程序员可能会提供多个连接服务端的IP:Port，那么客户端应该选择哪一个去连接服务端呢
         *  这就是HostProvider的作用， 默认创建是 StaticHostProvider，
         */
    ...
    private static HostProvider createDefaultHostProvider(String connectString) {
        // ConnectStringParser 仅仅是将 IP 字符串 解析成  InetSocketAddress
